...
<head>
  ...
  <link href="includes/side.css" rel="stylesheet" >
</head>
<?php
    ...
    <div class="row ">
        <div class="col-xl-4 col-lg-6">
            <div class="card l-bg-cherry">
                <div class="card-statistic-3 p-4">
                    ...
                    <div class="mb-4">
                        <h5 class="card-title mb-0">Catagories</h5>
                    </div>
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card l-bg-blue-dark">
                <div class="card-statistic-3 p-4">
                    <div class=""><i class="fa-solid fa-users"></i></div>
                    <div class="mb-4">
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card l-bg-green-dark">
                <div class="card-statistic-3 p-4">
                    <div class=""><i class=""></i></div>
                    <div class="mb-4">
                        <h5 class="card-title mb-0">New inquries</h5>
                    </div>
                    <div class="row align-items-center mb-2 d-flex">
                        <div class="col-8">
                            <h2 class="d-flex align-items-center mb-0">
        ...
        <div class="col-xl-4 col-lg-6">
            <div class="card l-bg-gray">
                <div class="card-statistic-3 p-4">
                    <div class="card-icon card-icon-large"><i class="fas fa-"></i></div>
                    <div class="mb-4">
